      ...
      <div className="w-full px-4 pt-32 pb-16 sm:px-8 sm:pt-36 sm:pb-16 lg:px-20 lg:pt-[206px] lg:pb-20">
        <div className="max-w-[1280px] mx-auto">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-12">
            <motion.div 
              className="max-w-full lg:max-w-[707px] flex flex-col gap-6 sm:gap-8 lg:gap-12"
            ...
            >
              <div className="flex flex-col gap-3 sm:gap-4">
                <motion.h1 
                  className="text-white text-[28px] leading-[1.3] sm:text-[36px] sm:leading-[1.35] lg:text-[56px] lg:leading-[78.4px] font-bold max-w-full sm:max-w-[500px] lg:max-w-[625px]"
            ...
            <motion.div 
              className="hidden md:block w-full md:w-[350px] lg:w-[556px] h-auto md:h-[300px] lg:h-[474px] relative mx-auto lg:mx-0"
