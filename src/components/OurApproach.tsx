...
const OurApproach = () => {
  return (
    <section
      id="about"
      className="w-full px-4 py-12 sm:px-8 sm:py-16 lg:p-20 bg-primary-50 relative overflow-hidden"
    >
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-10 lg:gap-0">
          <div className="w-full lg:w-[469px] flex flex-col gap-3">
            ...
            <p className="text-grey-1000 text-[16px] sm:text-[17px] lg:text-[18px] font-normal leading-[1.5] lg:leading-[27px]">
              We offer a calm, confidential space to talk through your
              situation, understand your circumstances, and explore what support
            ...
            {approaches.map((approach) => (
              ...
              >
                <div className="flex-shrink-0 w-[56px] h-[56px] sm:w-[64px] sm:h-[64px] lg:w-[73px] lg:h-[73px] bg-white rounded-full shadow-[0px_4px_4px_rgba(0,0,0,0.15)] flex items-end justify-center pt-2 pb-2">
                  <span
                    className={`${approach.numberColor} text-[28px] sm:text-[32px] lg:text-[38px] font-bold leading-[1.4] text-center`}
                  >
                    {approach.number}
                  </span>
                </div>
      ...
      <img
        ...
        alt=""
        className="hidden lg:block absolute left-[595px] top-[328.48px] w-[127.66px] h-auto -rotate-[5deg] origin-top-left"
        aria-hidden="true"
      />
    </section>
  );
