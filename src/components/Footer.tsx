      ...
      <div className="max-w-[1280px] mx-auto flex flex-col gap-10 md:gap-12 lg:gap-16 text-white">
        <div className="flex flex-col gap-10 md:gap-12 lg:flex-row lg:justify-between lg:items-start">
          <div className="w-full lg:w-[256px] flex flex-col gap-4 md:gap-6">
            ...
            <p className="text-white text-sm md:text-base font-medium leading-relaxed md:leading-6">
          ...
          <div className="grid grid-cols-2 gap-8 md:flex md:gap-8 lg:gap-8 lg:justify-end lg:flex-1">
            <div className="flex flex-col gap-4 md:gap-6 md:w-[172px]">
              <h4 className="text-white text-lg md:text-xl font-medium leading-7">Quick Links</h4>
              <ul className="flex flex-col gap-2 md:gap-3">
                {quickLinks.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-white text-sm md:text-base font-medium leading-6 hover:opacity-80 transition-opacity"
                    >
                      {link}
                    </a>
                  </li>
            ...
            <div className="flex flex-col gap-4 md:gap-6 md:w-[187px]">
              <h4 className="text-white text-lg md:text-xl font-medium leading-7">Services</h4>
              <ul className="flex flex-col gap-2 md:gap-3">
            ...
            <div className="col-span-2 md:col-span-1 flex flex-col gap-4 md:gap-6 md:w-[283px]">
              <h4 className="text-white text-lg md:text-xl font-medium leading-7">Contact Us</h4>
              <div className="flex flex-col gap-3 md:gap-4">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-white flex-shrink-0 mt-0.5" />
                  <span className="text-white text-sm md:text-base font-medium leading-relaxed md:leading-6">
                    19 College Parade, Salusbury Road, London, NW6 6RN
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-white flex-shrink-0" />
                  <span className="text-white text-sm md:text-base font-medium leading-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    className="text-white text-sm md:text-base font-medium leading-6 hover:opacity-80 transition-opacity break-all md:break-normal"
                  >
        ...
        <div className="pt-6 md:pt-8 border-t border-white/30 opacity-90">
          <p className="text-white text-sm md:text-base font-medium leading-6 text-center">
